...
public class BoardingRecordDTO {
    ...
    public BoardingRecordDTO(String checkInTime, String checkInCondition, String checkOutTime, String checkOutCondition) {
    ...
    public void setCheckOutCondition(String checkOutCondition) {
        this.checkOutCondition = checkOutCondition;
    }
}
